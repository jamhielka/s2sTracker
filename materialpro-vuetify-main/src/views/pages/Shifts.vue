                ...
                <v-row>
                     <v-col cols="6">
                      <span>Start Time </span>
                        ...
                        <vue-timepicker format="hh:mm:ss A" v-model="editedItem.startTime" ></vue-timepicker>
                  </v-col>
                  <v-col cols="6">
                       <span>End Time </span>
                             <!-- 12-hour format, with AM/PM picker -->
                        <vue-timepicker format="hh:mm:ss A" v-model="editedItem.endTime" ></vue-timepicker>
                  </v-col>
                  <v-col cols="6">
                    <v-text-field
  ...
  methods: {
    ...
    async getForMerchantList() {
      ...
      await this.$api
        ...
        .then((response) => {
          ...
          const newArr = response.data.data.shifts;
    ...
    save() {
      ...
      if (this.editedIndex > -1) {
        this.$api
          .put("/admin/shift", this.editedItem, {
            headers: {
              Authorization: TToken,
            },
          })
        ...
        this.$api
          .post("/admin/shift", this.editedItem, {
            headers: {
              Authorization: TToken,
            },
          })
